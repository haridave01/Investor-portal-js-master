...
Create a new database object called "Application" and the UI for the user to create them.

The restrictions are:

- The account can create it for themselves or any account they have an "role" with via the Relationship object.
- The account must be "verified" to apply.
...
I didn't get time to fully implement the styling so feel free to make things as pretty as possible.
